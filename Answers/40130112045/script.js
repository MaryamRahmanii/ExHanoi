...
function exHanoi_1(start, aux, end, n) {
    if (n==1) {
        ...
        //   hanoi(end,aux,start,6);
        //  moves.push([start,aux]);
        //  hanoi(end,start,aux,2*n);
        //  hanoi(aux,start,end,3*n);
        //  moves.push([start,aux]);
        //  hanoi(end,start,aux,4*n);
        //  hanoi(aux,start,end,5*n);
         
         
          
         
        // exHanoi_1(start,aux,end,n-1);
        //  hanoi(end,aux,start,2*n);
        //  hanoi(start,end,aux,(3*n)+1);
        //  hanoi(aux,start,end,(4*n)+1);
